...
# Load data ----
data <- read_csv("data/analysis/extended_data_with_transformations_with_cbcl.csv")
...
perform_outlier_analysis <- function(model, model_name, save_plot = TRUE,
  ...
  if (save_plot) {
    ...
    plot_path <- file.path(plot_dir, paste0("outlier_diagnostics_cbcl_", safe_model_name, ".svg"))
...
# Save the output 
# Outlier IDs
write_csv(tibble(ID = results$all_outlier_ids), "data/analysis/h1_outliers_cbcl.csv")

# Outlier summary
write_csv(results$outlier_summary, "data/analysis/h1_outlier_summary_cbcl.csv")
...
# Save the output
# Outlier IDs
write_csv(tibble(ID = results_h2_general$all_outlier_ids), "data/analysis/h2_general_outliers_cbcl.csv")

# Outlier summary
write_csv(results_h2_general$outlier_summary, "data/analysis/h2_general_outlier_summary_cbcl.csv")
...
# Save the output
# Outlier IDs
write_csv(tibble(ID = results_h2_sadness$all_outlier_ids), "data/analysis/h2_sadness_outliers_cbcl.csv")

# Outlier summary
write_csv(results_h2_sadness$outlier_summary, "data/analysis/h2_sadness_outlier_summary_cbcl.csv")
...
# Save the output
# Outlier IDs
write_csv(tibble(ID = results_h2_anxiety$all_outlier_ids), "data/analysis/h2_anxiety_outliers_cbcl.csv")

# Outlier summary
write_csv(results_h2_anxiety$outlier_summary, "data/analysis/h2_anxiety_outlier_summary_cbcl.csv")
...
# Save the output
# Outlier IDs
write_csv(tibble(ID = results_h2_anger$all_outlier_ids), "data/analysis/h2_anger_outliers_cbcl.csv")

# Outlier summary
write_csv(results_h2_anger$outlier_summary, "data/analysis/h2_anger_outlier_summary_cbcl.csv")
...
# Save the output
# Outlier IDs
write_csv(tibble(ID = results_h3_general$all_outlier_ids), "data/analysis/h3_general_outliers_cbcl.csv")

# Outlier summary
write_csv(results_h3_general$outlier_summary, "data/analysis/h3_general_outlier_summary_cbcl.csv")
...
# Save the output
# Outlier IDs
write_csv(tibble(ID = results_h3_sadness$all_outlier_ids), "data/analysis/h3_sadness_outliers_cbcl.csv")

# Outlier summary
write_csv(results_h3_sadness$outlier_summary, "data/analysis/h3_sadness_outlier_summary_cbcl.csv")

# Anxiety-specific ----
fit_h3_anxiety <- lm(cbind(anxiety_maladaptive_score, anxiety_adaptive_score_ord) ~ extraversion + agreeableness +
                                            conscientiousness + neuroticism + openness + internalizing + sex, data = data)
results_h3_anxiety <- perform_outlier_analysis(fit_h3_anxiety, "H3_Anxiety")

# Save the output
# Outlier IDs
write_csv(tibble(ID = results_h3_anxiety$all_outlier_ids), "data/analysis/h3_anxiety_outliers_cbcl.csv")

# Outlier summary
write_csv(results_h3_anxiety$outlier_summary, "data/analysis/h3_anxiety_outlier_summary_cbcl.csv")
...
# Save the output
# Outlier IDs
write_csv(tibble(ID = results_h3_anger$all_outlier_ids), "data/analysis/h3_anger_outliers_cbcl.csv")

# Outlier summary
write_csv(results_h3_anger$outlier_summary, "data/analysis/h3_anger_outlier_summary_cbcl.csv")
...
write_csv(all_outlier_summaries, "data/analysis/all_outlier_summaries_cbcl.csv")
...
write_csv(tibble(ID = all_outlier_ids), "data/analysis/all_unique_outliers_cbcl.csv")