...
sink("data/analysis/mediation_output_cbcl.txt")
...
model_general <- "
  ...
  adaptive_score_box ~ a8*extraversion + a9*agreeableness + 
...
model_sadness <- "
  ...
  sadness_maladaptive_score ~ a1*extraversion + a2*agreeableness + 
                              a3*conscientiousness + a4*neuroticism +
                              a5*openness + a6*internalizing + a7*sex
  sadness_adaptive_score_ord ~ a8*extraversion + a9*agreeableness + 
                               a10*conscientiousness + a11*neuroticism +
                               a12*openness + a13*internalizing + a14*sex
...
model_anxiety <- "
  ...
  anxiety_maladaptive_score ~ a1*extraversion + a2*agreeableness + 
                              a3*conscientiousness + a4*neuroticism +
                              a5*openness + a6*internalizing + a7*sex
  anxiety_adaptive_score_ord ~ a8*extraversion + a9*agreeableness + 
                               a10*conscientiousness + a11*neuroticism +
                               a12*openness + a13*internalizing + a14*sex
  depression_score_yeo ~ b1*anxiety_maladaptive_score + b2*anxiety_adaptive_score_ord

  # Covariance between mediators
  anxiety_maladaptive_score ~~ anxiety_adaptive_score_ord
...
p_values_anxiety <- parameterEstimates(fit_anxiety) |>
  filter((lhs == "depression_score_yeo" | lhs == "anxiety_maladaptive_score" | lhs == "anxiety_adaptive_score_ord" | 
...
write_csv(adjusted_p_values, "data/analysis/mediation_adjusted_p_values_cbcl.csv")
